...
// ── DATA ──────────────────────────────────────────────────────────────────────
const articlesDB = [
  { id:'1', slug:'ferrari-sf90-review', title:'Ferrari SF90 Stradale: O Futuro Chegou', subtitle:'Hybrid com 1.000 cv que redefine o conceito de supercar italiana', category:'Supercarros', author:'Vitor Henrique', date:'2026-05-15', readTime:8, views:12483, image:'https://images.unsplash.com/photo-1734461672737-2a63709bee1f?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', featured:true, tags:['Ferrari','Híbrido','Supercar','Itália'], content:'O SF90 Stradale representa o ápice da engenharia Ferrari: motor V8 biturbo de 4.0L combinado com três motores elétricos entrega 986cv de potência total. Com aceleração de 0-100 km/h em apenas 2.5 segundos, este híbrido plug-in é uma declaração de intenções sobre o futuro da marca. O sistema de tração integral eletromagnética permite torque vetorial instantâneo em cada roda, algo impossível com mecânica convencional.', specs:{power:'986 cv',torque:'800 Nm',acceleration:'2.5s',topSpeed:'340 km/h',weight:'1570 kg'} },
  { id:'2', slug:'lamborghini-huracan-evo', title:'Lamborghini Huracán EVO: Raiva em Estado Puro', subtitle:'Tocador natural aspirado V10 com toda a tecnologia moderna', category:'Supercarros', author:'Victor Hugo', date:'2026-05-10', readTime:6, views:9821, image:'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', featured:true, tags:['Lamborghini','V10','Supercar'], content:'O Huracán EVO é a prova de que motores naturalmente aspirados ainda têm muito a dizer. Seu V10 5.2L gira livremente até 8.500 rpm produzindo 640cv com um som que poucos carros no mundo conseguem igualar. O sistema LDVI (Lamborghini Dinamica Veicolo Integrata) coordena todos os sistemas de controle do veículo com processamento em tempo real.', specs:{power:'640 cv',torque:'600 Nm',acceleration:'2.9s',topSpeed:'325 km/h',weight:'1422 kg'} },
  { id:'3', slug:'porsche-911-gt3', title:'Porsche 911 GT3 2024: Perfeição Refinada', subtitle:'O RS mais acessível que ainda domina pistas ao redor do mundo', category:'Esportivos', author:'Leonardo Bora', date:'2026-05-05', readTime:7, views:8450, image:'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80', featured:false, tags:['Porsche','911','GT3','Track'], content:'A Porsche revisitou cada detalhe do 911 GT3 para 2024. O motor flat-six 4.0L de 510cv com caixa PDK revisada oferece tempos de pista ainda melhores. O novo pacote aerodinâmico melhora downforce em 15% sem aumentar o arrasto, resultado de centenas de horas em túnel de vento.', specs:{power:'510 cv',torque:'470 Nm',acceleration:'3.4s',topSpeed:'320 km/h',weight:'1418 kg'} },
  { id:'4', slug:'bmw-m4-competition', title:'BMW M4 Competition xDrive: Praticidade Extrema', subtitle:'Quando você quer AWD sem perder a alma M', category:'Esportivos', author:'Victor Hugo', date:'2026-05-28', readTime:5, views:7230, image:'https://images.unsplash.com/photo-1724391114112-c83ad59f1d5f?q=80&w=1229&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', featured:false, tags:['BMW','M4','AWD','Turbo'], content:'Com o sistema xDrive, o M4 Competition ganhou um segundo de confiança nas saídas de curvas molhadas sem perder a característica traseira que todo fã da série M adora. O motor S58 de 510cv nunca foi tão acessível ao público geral, com modos de condução que vão do confortável ao selvagem.', specs:{power:'510 cv',torque:'650 Nm',acceleration:'3.5s',topSpeed:'290 km/h',weight:'1730 kg'} },
  { id:'5', slug:'mclaren-720s-spider', title:'McLaren 720S Spider: O Cabriolet Mais Rápido', subtitle:'Velocidade sem teto em todos os sentidos', category:'Supercarros', author:'Leonardo Bora', date:'2026-05-20', readTime:6, views:6890, image:'https://images.unsplash.com/photo-1615394695852-da39a8df9bf1?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', featured:false, tags:['McLaren','720S','Spider'], content:'A McLaren provou que um conversível não precisa sacrificar rigidez ou desempenho. O 720S Spider mantém 98% da performance do coupé com o benefício de poder abrir o teto em 11 segundos a até 50 km/h. O chassi MonoCell II-T de fibra de carbono garante rigidez torcional superior a qualquer cabriolet de massa.', specs:{power:'720 cv',torque:'770 Nm',acceleration:'2.9s',topSpeed:'341 km/h',weight:'1468 kg'} },
  { id:'6', slug:'aston-martin-vantage', title:'Aston Martin Vantage 2024: O Brit Aprimorado', subtitle:'Motor AMG, design icônico britânico e agora ainda mais agressivo', category:'Gran Turismo', author:'Vitor Henrique', date:'2026-05-15', readTime:5, views:5670, image:'https://images.unsplash.com/photo-1608340821332-3a73fadd890c?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', featured:false, tags:['Aston Martin','Vantage','V8'], content:'Redesenhado do zero, o novo Vantage traz o motor AMG 4.0L biturbo de 665cv numa carroceria completamente nova com maior downforce e melhores saídas de ar. O interior premium da Aston não perde o charme britânico, mas incorpora a mais recente tecnologia de infotainment.', specs:{power:'665 cv',torque:'800 Nm',acceleration:'3.5s',topSpeed:'325 km/h',weight:'1595 kg'} },
];
