...
const articlesDB = [
  ...
  { id:'4', slug:'bmw-m4-competition', title:'BMW M4 Competition xDrive: Praticidade Extrema', subtitle:'Quando você quer AWD sem perder a alma M', category:'Esportivos', author:'Victor Hugo', date:'2026-05-28', readTime:5, views:7230, image:'https://unsplash.com/pt-br/fotografias/um-carro-branco-moderno-estacionado-em-uma-rua-ibdigxM7KA4', featured:false, tags:['BMW','M4','AWD','Turbo'], content:'Com o sistema xDrive, o M4 Competition ganhou um segundo de confiança nas saídas de curvas molhadas sem perder a característica traseira que todo fã da série M adora. O motor S58 de 510cv nunca foi tão acessível ao público geral, com modos de condução que vão do confortável ao selvagem.', specs:{power:'510 cv',torque:'650 Nm',acceleration:'3.5s',topSpeed:'290 km/h',weight:'1730 kg'} },
  { id:'5', slug:'mclaren-720s-spider', title:'McLaren 720S Spider: O Cabriolet Mais Rápido', subtitle:'Velocidade sem teto em todos os sentidos', category:'Supercarros', author:'Leonardo Bora', date:'2026-05-20', readTime:6, views:6890, image:'https://unsplash.com/pt-br/fotografias/lamborghini-aventador-laranja-e-preto-d3Nuz-3LtA8', featured:false, tags:['McLaren','720S','Spider'], content:'A McLaren provou que um conversível não precisa sacrificar rigidez ou desempenho. O 720S Spider mantém 98% da performance do coupé com o benefício de poder abrir o teto em 11 segundos a até 50 km/h. O chassi MonoCell II-T de fibra de carbono garante rigidez torcional superior a qualquer cabriolet de massa.', specs:{power:'720 cv',torque:'770 Nm',acceleration:'2.9s',topSpeed:'341 km/h',weight:'1468 kg'} },
  { id:'6', slug:'aston-martin-vantage', title:'Aston Martin Vantage 2024: O Brit Aprimorado', subtitle:'Motor AMG, design icônico britânico e agora ainda mais agressivo', category:'Gran Turismo', author:'Vitor Henrique', date:'2026-05-15', readTime:5, views:5670, image:'https://unsplash.com/pt-br/fotografias/porsche-azul-911-na-areia-marrom-sob-nuvens-brancas-durante-o-dia-yxyIwykexwg', featured:false, tags:['Aston Martin','Vantage','V8'], content:'Redesenhado do zero, o novo Vantage traz o motor AMG 4.0L biturbo de 665cv numa carroceria completamente nova com maior downforce e melhores saídas de ar. O interior premium da Aston não perde o charme britânico, mas incorpora a mais recente tecnologia de infotainment.', specs:{power:'665 cv',torque:'800 Nm',acceleration:'3.5s',topSpeed:'325 km/h',weight:'1595 kg'} },
];
